    ...
    vec![
        MovementDef {
            ...
            lines: lines![
                ...
                ("≝", "sustained mobilization ∧ collective identity ∧ ¬nominates_candidates"),
                ("∂", [
                    "⌯⊅⍚ (⌯ diffuse | ⍚ institutionalized)",
                    "⌯⊅⚐ (⌯ ¬nominates | ⚐ nominates candidates)",
                ...
                ("⊛", [
                    ...
                    "⌯⦑Solidarity (Poland)|Arab Spring|Umbrella Movement|Landless Workers' Movement (Brazil)⦒",
                ...
                ("◻", [
                    "discrimination:",
                    "  ⌯⦑Frankfurt School⦒ vs ⍚⦑Institute for Social Research⦒",
                    "  ⌯⦑Zionism (pre-state)⦒ vs ⚐⦑Likud⦒",
                    "  ⌯⦑Peronism⦒ vs ⚐⦑Partido Justicialista (PJ)⦒",
